...
func DemoStruct() {
	...
	*emp = Employee{Name: "Super hr", Salary: 1000}
	///!!! интересно что при таком создании выводится данные структуры, без необходимости
	// разыменования как было выше
	fmt.Println(emp)

	// 2 структуры сравнимы на == и != ттт когда имеют одинаковый тип и их поля также явл
	// сравниваемыми типами данных
	p2 := Point2d{1, 1}
	fmt.Println(p1 == p2)
}
...
func DemoEmbeddedStruct() {
	...
	// однако данный сахар не работает при использовании структурных литералов
